...
/**
 * An abstract fragment providing basic functionality of searching the webpage via toolbar
 * searchview and subjects discovery feature if enabled.
 */
public abstract class WebViewDiscoverFragment extends BaseWebViewFragment {
    ...
    private FragmentWebviewDiscoveryBinding binding;
    private SearchView searchView;
    private ToolbarCallbacks toolbarCallbacks;

    protected abstract boolean shouldShowSubjectDiscovery();
        ...
        try {
            ...
            final PopularSubjectsAdapter adapter = new PopularSubjectsAdapter(popularSubjects, new PopularSubjectsAdapter.ClickListener() {
                ...
                public void onViewAllSubjectsClick() {
                    environment.getRouter().showSubjectsActivityForResult(WebViewDiscoverFragment.this,
